...
import { View, ImageBackground, Text, ActivityIndicator, TouchableOpacity, Dimensions, Platform, PixelRatio } from "react-native";
...
export default class UpdateView extends PureComponent {
    render() {
        const { modalBorderRadius, width, message, progress, isMandatory, progressDesc, onDownload, onIgnore, packageSizeDesc, restartApp, successBtnText } = this.props;
          ...
          {this.props.headerImg !== undefined ?
                ...
                :
                    <ImageBackground style={{
                        ...
                        }} imageStyle={{ borderTopLeftRadius: modalBorderRadius, borderTopRightRadius: modalBorderRadius }} resizeMode="contain" source={this.props.headerImgSrc ? this.props.headerImgSrc : require("./imgs/app_update_bg.png")}/>}
        <View style={{
                backgroundColor: "#fff",
          ...
          <View style={{ flex: 1, overflow: 'hidden' }}>
            <WebView source={webviewSource} automaticallyAdjustContentInsets 
        // scalesPageToFit
        ...
        <View style={{ backgroundColor: "#fff", paddingVertical: 15, borderBottomLeftRadius: modalBorderRadius, borderBottomRightRadius: modalBorderRadius }}>
          <TouchableOpacity activeOpacity={0.8} onPress={() => {
            ...
            {this.props.progress ? (<View style={[{ flexDirection: "row", alignItems: "center" }]}>
                {progress < 1 ?
