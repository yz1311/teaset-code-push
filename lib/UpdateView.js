...
import { View, ImageBackground, Text, ActivityIndicator, TouchableOpacity, Dimensions, WebView, PixelRatio } from "react-native";
    ...
    render() {
        ...
        <View style={{
          ...
          <View style={{ flex: 1, overflow: 'hidden' }}>
            <WebView source={{ html: `<html style="font-size: ${PixelRatio.getPixelSizeForLayoutSize(16)}px;">${this.props.message}</html>` }} automaticallyAdjustContentInsets 
        // scalesPageToFit
